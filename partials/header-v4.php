...
<header id="header-main" class="cd-morph-dropdown">
    ...
    <div class="bg-primary-darker position-relative">
        <nav class="container item-flex">
            ...
            <ul class="nav-primary-v4 hidden-sm-down item-flex-main main-nav">
					...
					<li id="two" class="dropdown">
						<div class="content">
                            ...
                            <a class="bg-gray-lighter p-a item-flex" href="#">
                                <img src="http://acgmeetings.acggi.net/wp-content/themes/acgmeetings/svg/logo-type.svg" class="" width="70">
