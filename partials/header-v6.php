    ...
    <div class="header-main" role="banner">
        <div class="container">
            <div class="item-flex">
                ...
                <div class="item-flex-addon item-flex flex-column align-items-flex-end p-y-sm">
                    <div class="text-sm" role="directory" id="header-hud">
                        <div class="item-flex justify-content-flex-end p-b-sm">
                            ...
                            <div class="item-flex-addon">
                                <a href="#" class="btn btn-primary-outline btn-sm br-a-0"><svg class="icon icon-users"><use xlink:href="#icon-users"></use></svg> My ACG/Log In</a>
                            </div>
                        </div>
                    </div>
...
<!-- menu modal -->
<div class="modal modal-menu fade m-a-md m-lg-x-0" tabindex="-1">
    <div class="modal-dialog modal-dialog-lg modal-lg">
        <div class="modal-content">
            <div class="modal-body">
                <div class="text-right">
                    <button type="button" class="circle bg-primary text-inverse text-xl" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="p-x p-b">
                    <?php include 'nav.php' ?>
                </div>
