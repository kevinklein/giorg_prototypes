    ...
    <main class="container p-y p-lg-y-xl main-content">
		<div class="row">
			...
			<div class="col-md-2 col-xs-12">
				...
				<div id="localnav">
					<h2 class="text-normal text-500 p-l">Clinical Guidelines</h2>
					<div class="card">
						<ul class="nav-secondary-v5">
							<li class="active"><a href="#">Browse All Guidelines</a>
								<ul>
									<li><a href="#">ACG Guidelines</a></li>
									<li><a href="#">Multi-society Documents</a></li>
									<li><a href="#">Monographs</a></li>
									<li><a href="#">Competencies in Endoscopy</a></li>
									<li><a href="#">Guidelines in Progress</a></li>
								</ul>
							</li>
					...
					<a class="bg-gray-lightest p-a display-block" href="#">
						<div class="item-flex m-b-sm">
							<span class="circle bg-secondary text-inverse"><svg class="icon icon-mobile"><use xlink:href="#icon-mobile"></use></svg></span>
							<div class="p-l-sm item-flex-main">
								<span class="text-xs display-block text-muted">On a mobile phone<br> or a tablet?</span>
							</div>
						</div>
						<div class="text-dark text-normal text-500 text-left">Download the ACG Guidelines App</div>
					</a>
				</div>
